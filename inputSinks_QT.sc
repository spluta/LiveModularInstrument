...
//
// 	makeSink {
// 		sink = DragSink(panel, Point(25, 32)).maxSize_(Size(25,32).minSize(Size(25, 32));
// 		}
//
// 		getCurrentPoint {
...
// 	}
//
// 	QtMixerBusAssignSink : BusAssignSink {
//
// 		makeSink {
...
// 	}
//
// 	QtDiscreteInput_Mod : ModularMixerStrip {
//
...
//
// 			panel = CompositeView.new(win, Point(50, 300));
//
