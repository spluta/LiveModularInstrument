...
if __name__ == "__main__":
  ...
  model = load_model("/Users/spluta/Library/Application Support/SuperCollider/Extensions/LiveModularInstrument/modules/NN_Synths/01_CrossFeedback1/modelFile1.h5")
    ...
    for y0 in range(0,size):
      ...
      for x1 in range(0,size):
        for y1 in range(0,size):
          output = model.predict(np.array([[x0/size,y0/size,x1/size,y1/size]]))
          #print(np.round(output[0],3))
