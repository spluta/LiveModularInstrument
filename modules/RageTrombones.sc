...
// 				var sound, amp, synthGate, freq, hasFreq, osc, sim, filtersOsc, filtersNoise, amps, modAmp, modulator, chain, centroid, trig, gliss, thresh, noiseThresh, noiseGate;
// 				var env, muteEnv;
//
...
// 				modAmp = centroid*2;
//
// 				modulator = SelectX.ar(Lag.kr(hasFreq,0.1), [filtersNoise*modAmp*4, SinOsc.ar(freq*2, 0, modAmp)]);
//
